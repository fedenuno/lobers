        ...
        <div class="auth-fluid">
            ...
            <div class="auth-fluid-right text-center">
                <div class="auth-user-testimonial">
                    <p class="lead"><i class="mdi mdi-format-quote-open"></i> No me preocupa que quieran robar mis ideas, me preocupa que ellos no las tengan. <i class="mdi mdi-format-quote-close"></i>
                    </p>
                    <p>
                        - Nikola Tesla
                    </p>
